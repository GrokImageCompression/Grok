...
grk_codestream_index* CodeStreamDecompress::getIndex(void){
	return cstr_index;
}
...
bool CodeStreamDecompress::decompress_tile_t2t1(TileProcessor *tileProcessor) {
	auto decompressor = &m_decompressorState;
